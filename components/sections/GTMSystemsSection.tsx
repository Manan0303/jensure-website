...
export default function GTMSystemsSection() {
  return (
    <SectionContainer id="gtm-systems" className="bg-brand-surface">
      <div className="mb-12">
        <p className="text-sm font-semibold uppercase tracking-widest text-brand-cta mb-3">GTM Systems</p>
        ...
        <p className="mt-5 text-lg text-brand-text/60 max-w-2xl leading-relaxed">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {GTM_COMPONENTS.map((component) => (
          ...
          >
            ...
            <h3 className="text-base font-semibold text-brand-text">{component.title}</h3>
            <p className="text-sm text-brand-text/55 leading-relaxed">{component.description}</p>
          </div>
        ))}
      </div>
    </SectionContainer>
