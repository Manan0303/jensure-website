...
const FAQS = [
  { q: 'How much does AI automation cost?', a: 'Targeted workflow automations start from $100. Full AI Department builds — covering an entire business function like sales, marketing, or operations — start from $1,500/month. Every engagement begins with a free audit so you know exactly what you are getting before committing.' },
  { q: 'How long does it take to deploy an AI Department?', a: 'A single targeted automation takes 1–3 weeks. A full AI Department covering multiple workflows takes 3–6 weeks depending on integrations and complexity.' },
  { q: 'What is the difference between Jensure and off-the-shelf automation tools?', a: 'Tools like Zapier and Make connect apps with simple if-then rules. Jensure builds complete operational systems — AI agents that handle variation, coordinate across channels, and run entire workflows end-to-end without human involvement.' },
  ...
  { q: 'What results can I realistically expect?', a: 'Based on client deployments: reporting time reduced from hours to minutes, outreach volume increased 10×, admin time reduced by 70–80%, and teams refocused on strategic work within weeks of deployment.' },
]
