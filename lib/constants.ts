...
export const CASE_STUDY_PREVIEWS: CaseStudyPreview[] = [
  { industry: 'Recruitment — Sales Automation', headline: 'Recruitment firm went from months of manual follow-up to booked meetings from month two with AI outreach', metric: 'Month 2', metricLabel: 'first meetings booked', slug: 'recruitment-sales-automation' },
