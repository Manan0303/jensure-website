...
const PRINCIPLES = [
  { label: '70%', desc: 'Average operational work automatable' },
  { label: '5+', desc: 'AI Department types built' },
  { label: '17', desc: 'Industries served' },
  { label: '∞', desc: 'Processes that can be systematised' }
]
    ...
    <>
      ...
      <SectionContainer className="bg-brand-bg">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div {...fadeUp(0.15)} className="bg-brand-surface border border-brand-accent/20 rounded-2xl p-8 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-40 h-40 bg-brand-accent/5 rounded-full -translate-y-1/2 translate-x-1/2" />
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-brand-cta/5 rounded-full translate-y-1/2 -translate-x-1/2" />
            <div className="relative">
              <div className="text-brand-cta text-3xl mb-4">&ldquo;</div>
              <blockquote className="text-2xl font-bold text-brand-text leading-tight mb-6">
